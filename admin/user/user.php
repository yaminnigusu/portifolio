  ...
  <body>
    ...
    <div class="row">
        <div class="col-lg-12">
           ...
           <h1 class="page-header" id="userHeader">List of Users <a href="add.php" class="btn btn-success btn-add-user" id="addUserButton"><i class="bx bx-plus"></i> Add user</a></h1>
...
// Display testimonials in the table
...
?>
 ...
 <!-- Add Testimonial Form (Initially Hidden) -->
              ...
              <div class="col-lg-8 col-md-6">
                <div class="d-flex align-items-center justify-content-center" style="height: 75px;">
                  <p class="mb-0">
                    ...
                    Developed by <a class="text-white border-bottom" href="https://htmlcodex.com">quantum digital Technologies, PLC</a>
                  </p>
                </div>
              </div>
            </div>
...
<script src="script.js"></script>
  <!-- Footer End -->
    <!-- JavaScript -->
    <!-- JavaScript to toggle between List of Clients and Add Client Form -->
<!-- JavaScript to toggle between List of Testimonials and Add Testimonial Form -->
  </body>
</html>
