  ...
  <nav class="sidebar">
      <div class="menu_content">
        ...
        <ul class="menu_items">
          ...
          <li class="item">
            <a href="testimonial.php" class="nav_link">
              <span class="navlink_icon">
...
if (mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        echo "<tr>";
        echo "<td>" . $row['id'] . "</td>";
        echo "<td><img src='" . $row['PHOTO'] . "' style='width: 100px; height: auto;' alt='testimonial photo'></td>";
        echo "<td>" . $row['NAME'] . "</td>";
              ...
              <div class="col-lg-8 col-md-6">
                <div class="d-flex align-items-center justify-content-center" style="height: 75px;">
                  <p class="mb-0">
                    ...
                    Developed by <a class="text-white border-bottom" href="https://ennlite.com">quantum digital Technologies, PLC</a>
                  </p>
                </div>
              </div>
            </div>
